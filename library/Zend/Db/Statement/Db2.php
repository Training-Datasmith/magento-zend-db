...
class Zend_Db_Statement_Db2 extends Zend_Db_Statement
{
     ...
     * @throws Zend_Db_Statement_Db2_Exception
     */
    public function _bind_param($parameter, &$variable, $type = null, $length = null, $options = null): bool
    {
        if ($type === null) {
            $type = DB2_PARAM_IN;
        }
    ...
    public function error_info()
    {
         ...
         */
        return [$error, $error, db2_stmt_errormsg()];
    }
    /**
    ...
    public function _execute(?array $params = null)
    {
        ...
        $this->_keys = [];
        if ($field_num = $this->column_count()) {
